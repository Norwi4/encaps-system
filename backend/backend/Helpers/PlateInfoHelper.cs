...
public static class PlateInfoHelper
{
    ...
    private static readonly Dictionary<string, string> ColumnToPropertyMap = new()
    {
        ...
        { "react_q_i_l1", "ReactQIL1" },
        { "react_q_i_l2", "ReactQIL2" },
        { "react_q_i_l3", "ReactQIL3" },
        { "react_q_i_sum", "ReactQISum" },
        { "react_qc_l1", "ReactQCL1" },
        { "react_qc_l2", "ReactQCL2" },
        { "react_qc_l3", "ReactQCL3" },
        { "react_q_c_l1", "ReactQCL1" },
        { "react_q_c_l2", "ReactQCL2" },
        { "react_q_c_l3", "ReactQCL3" },
        { "react_q_c_sum", "ReactQCSum" },
        { "react_q_l1", "ReactQL1" },
        { "react_q_l2", "ReactQL2" },
        { "react_q_l3", "ReactQL3" },
        { "react_q_sum", "ReactQSum" },
        { "h_u_l1", "HUL1" },
        { "h_u_l2", "HUL2" },
        { "h_u_l3", "HUL3" },
        { "h_i_l1", "HIL1" },
        ...
        { "all_energy_r_k", "AllEnergyRK" },
        // Полная мощность (apparent power) - маппинг на Aq1, Aq2, Aq3, AqSum
        { "s_l1", "Aq1" },
        { "s_l2", "Aq2" },
        { "s_l3", "Aq3" },
        { "s_sum", "AqSum" },
